...
[EasyPicker（轻取）](https://docs.ep.sugarat.top/) 是一个在线文件收取平台，用于快速创建收集任务、提交文件、管理人员与统计结果。

当前仓库已整合 EasyPicker2.0 的前端与服务端代码，采用 monorepo 方式维护：
...
1. 前后端 Monorepo：https://github.com/ATQQ/easypicker2-client
